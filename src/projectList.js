...
export const showcaseProjects = [
  {
    ...
    gitLink: 'https://github.com/jayullman/pinbored',
    liveLink: 'https://pinbored.herokuapp.com/',
    description:
      "Final full stack application for freeCodeCamp's back end certification. Pin and like images" +
  ...
  },
  {
    ...
    techList: ['html', 'css', 'javascript', 'react', 'react router', 'mongoDB', 'node', 'express'],
    gitLink: 'https://github.com/jayullman/voting-app',
  ...
  },
  {
    ...
    techList: ['html', 'css', 'javascript', 'react', 'react router', 'mongoDB', 'node', 'express'],
    gitLink: 'https://github.com/jayullman/book-trading-club',
  ...
  },
  {
    ...
    gitLink: 'https://github.com/jayullman/chore-chart',
    liveLink: 'https://jayullman.github.io/chore-chart/',
    description: 'Final Project for CS50. A chore tracker for housemates utilizing React and Redux.',
    longDescription: [
      "<a target='_blank' href='https://www.youtube.com/watch?v=bEA-askLQUU&feature=youtu.be'>View my 2 minute presentation</a>",
  ...
  },
  {
    ...
    gitLink: 'https://github.com/jayullman/dungeon-crawler',
    liveLink: 'https://jayullman.github.io/dungeon-crawler/',
  ...
  },
  {
    ...
    gitLink: 'https://github.com/jayullman/nightlife-coordination',
  ...
  },
  {
    ...
    techList: ['html', 'css', 'javascript', 'react'],
    gitLink: 'https://github.com/jayullman/game-of-life',
    liveLink: 'https://jayullman.github.io/game-of-life/',
  ...
  },
  {
    ...
    gitLink: 'https://github.com/jayullman/simon',
    liveLink: 'https://jayullman.github.io/simon/',
  ...
  },
  {
    ...
    gitLink: 'https://github.com/jayullman/stocks',
...
export const moreProjects = [
  {
    ...
    gitLink: 'https://github.com/jayullman/recipe-box',
    liveLink: 'https://jayullman.github.io/recipe-box/',
    description:
      'An app created with React.js and Redux that uses localStorage to store state. ' +
  ...
  },
  {
    ...
    gitLink: 'https://github.com/jayullman/file-metadata-ms',
  ...
  },
  {
    ...
    gitLink: 'https://github.com/jayullman/image-search',
  ...
  },
  {
    ...
    gitLink: 'https://github.com/jayullman/markdown-previewer',
    liveLink: 'https://jayullman.github.io/markdown-previewer/',
    description:
      'Type text with Markdown syntax in one pane, and see it converted in real-time to ' +
  ...
  },
  {
    ...
    techList: ['html', 'css', 'javascript', 'react'],
    gitLink: 'https://github.com/jayullman/JavaScript-Calculator',
  ...
  },
  {
    ...
    gitLink: 'https://github.com/jayullman/d3-meteorite-landings',
    liveLink: 'https://jayullman.github.io/d3-meteorite-landings/',
  ...
  },
  {
    ...
    techList: ['javascript', 'D3', 'Webpack\u00a02'],
    gitLink: 'https://github.com/jayullman/d3-heat-map',
    liveLink: 'https://jayullman.github.io/d3-heat-map/',
    description:
      'Request JSON data containing the global land-surface temperature from 1753 - 2015.' +
  ...
  },
  {
    ...
    techList: ['javascript', 'react', 'node', 'express', 'mongoDB'],
    gitLink: 'https://github.com/jayullman/url-shortener',
  ...
  },
  {
    ...
    gitLink: 'https://github.com/jayullman/timestamp-microservice',
    liveLink: 'https://fcc-timestamper-ms.herokuapp.com/',
    description:
      'API endpoint that accepts a string or Unix ' +
  ...
  },
  {
    ...
    techList: ['javascript', 'react', 'fullstack'],
    gitLink: 'https://github.com/jayullman/req-header-parser-ms',
    liveLink: 'https://req-header-ms.herokuapp.com/',
    description:
      'API endpoint that parses client header information and returns the parsed information as a JSON object.',
    longDescription: [],
  ...
  },
  {
    ...
    gitLink: 'https://github.com/jayullman/d3-scatterplot-graph',
    liveLink: 'https://jayullman.github.io/d3-scatterplot-graph/',
  ...
  },
  {
    ...
    techList: ['javascript', 'react', 'fullstack', 'D3'],
    gitLink: 'https://github.com/jayullman/d3-force-directed-graph',
    liveLink: 'https://jayullman.github.io/d3-force-directed-graph/',
  ...
  },
  {
    ...
    gitLink: 'https://github.com/jayullman/d3-bar-chart',
    liveLink: 'https://jayullman.github.io/d3-bar-chart/',
    description:
      'App makes an AJAX request for JSON data from the Federal Reserve Economic Data and ' +
  ...
  },
  {
    ...
    description:
      'App generates a random quote from received AJAX request from the forismatic API. ' +
  ...
  },
  {
    ...
    techList: ['javascript', 'html', 'css'],
    gitLink: 'https://github.com/jayullman/local-weather',
    liveLink: 'https://jayullman.github.io/local-weather/index.html',
    description:
      "Requests weather data from OpenWeatherMap's API and displays the local weather based on client location.",
    longDescription: [],
    userStories: [
