...
class Header extends Component {
  constructor(props) {
    ...
    this.header;
    this.foregroundCloudTimeout;
    this.randomCloudTimeout = null;
  }
  ...
  componentDidMount() {
    ...
    const startClouds = () => {
      ...
      this.foregroundCloudTimeout = setInterval(populateClouds.bind(this), 5000);
      this.randomCloudTimeout = setInterval(createForeGroundCloud.bind(this), 8000);
    };

    const stopClouds = () => {
      clearInterval(this.foregroundCloudTimeout);
      clearInterval(this.randomCloudTimeout);
    };
    ...
    const createCloud = () => {
      ...
      this.header.appendChild(cloudElement);
    };
    ...
    const createForeGroundCloud = () => {
      ...
      var cloudStyle = "bottom: 48%; left: -200%; font-size: 12em; z-index: 100; " +
